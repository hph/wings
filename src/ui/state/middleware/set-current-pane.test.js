...
describe('setCurrentPane', () => {
  ...
  it('should handle a CREATE_PANE action by updating the config to set the current pane', () => {
  ...
  it('should handle a DESTROY_PANE action by updating the config to set another current pane', () => {
    const { updateConfig } = require('../actions'); // eslint-disable-line global-require
