...
describe('removeFromCursor', () => {
  it('should not do anything if on the last character', () => {
    expect(commands.removeFromCursor({
      column: 0,
      row: 0,
      lines: [''],
    })).toEqual({
...
describe('moveRightMaybeAfterEnd', () => {
  it('should move right', () => {
    expect(commands.moveRightMaybeAfterEnd({
      column: 0,
      row: 0,
      lines: ['hello'],
    }).column).toEqual(1);
...
describe('moveToFirstNonWhitespace', () => {
  it('should not move on an empty line', () => {
    expect(commands.moveToFirstNonWhitespace({
      row: 0,
      lines: [''],
    }).column).toEqual(0);
  });
